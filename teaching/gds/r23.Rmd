...
- Using the same crossvalidation setup, train a *logistic* model (`method='glm', family='binomial'`) to predict whether a song is a rock song based on the same covariates.
