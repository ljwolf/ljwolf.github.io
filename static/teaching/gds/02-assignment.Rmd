...
Fit a multilevel model using `lmer` that allows both the baseline earnings and the impact of height on earnings to vary. Show me the table of estimates using `tidy`.[^hint-broommixed]
