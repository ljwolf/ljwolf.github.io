...
I *really* like the University of Bristol's new [email charter](https://bristol.ac.uk/media-library/sites/hr/documents/wellbeing/email-charter.pdf). But, I think it could be made a little more clear and actionable, especially since it can build off of previous work and thought about making emails clearer, shorter, and fewer in number. Below, I'll go through the points listed in the original charter and try to make them clearer. I'll also try to add some *actions* that add some teeth to the points. My comments are in italics.  
...
- *A few practices I've seen that help this include:*
  1. [*Never send an email longer than 5 sentences*](http://five.sentenc.es/). 
...
- *[Dissent-based decisionmaking](https://en.wikipedia.org/wiki/Blackballing), where the motion is carried unless a certain threshold of individuals dissent, helps reduce empty "I agree" responses required by majoritarian balloting
