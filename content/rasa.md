...
**Stewart Fotheringham (ASU)**

### _Pattern_

Geographers often describe the “structure” of a geographical process as exhibiting _pattern_ when attempting to represent geographical processes in statistical models. But, what each geographer means, exactly, by _pattern_ has historically been contentious. This chapter will discuss different notions of _pattern_ in geographical analysis, and take a perspective on how _pattern_ might evolve in new areas of geographical study.

**Trisalyn Nelson (University of California, Santa Barbara) (TBC) **
...
**Chris Brunsdon (Maynooth)**

## _Agendas for Domains of Practice_
